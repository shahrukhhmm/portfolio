...
//aboutbtn
const qualibtn= document.querySelector('.qualifi-btn');
const expertbtn= document.querySelector('.experties-btn');
const qua_box= document.querySelector('.qualify-box');
const exp_box= document.querySelector('.expert-box');

qualibtn.addEventListener('click', ()=> {
  qua_box.style.display='flex';
...
expertbtn.addEventListener('click', ()=> {
  ...
  qua_box.style.display='none';

  exp_box.style.display='flex';
